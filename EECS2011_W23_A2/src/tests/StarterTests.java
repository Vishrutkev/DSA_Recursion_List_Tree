...
public class StarterTests {
	...
	public void test_getGroupedStrings_03() {
		 ...
		 * 	less than 2 (i.e., 0, 1) 
		 */
		assertEquals("aaa"		, output.getElement());
		assertEquals("aaa"			, output.getNext().getElement());
		/* 
		 * Group 2: strings from the input chain whose lengths are 
		 * 	greater than or equal to 2 and less than 4 (i.e., 2, 3) 
		 */
		System.out.println(output.getNext().getNext().getElement());
		assertEquals("vwxyzjaa"		, output.getNext().getNext().getElement());
		assertEquals("xyaa"		, output.getNext().getNext().getNext().getElement());
		assertEquals("ghicaa"		, output.getNext().getNext().getNext().getNext().getElement());
		/* 
		 * Group 3: strings from the input chain whose lengths are 
		 * 	greater than or equal to 4 (i.e., 4, 5, ...) 
		 */
		assertEquals("pqrstuaa"	, output.getNext().getNext().getNext().getNext().getNext().getElement());
		assertEquals("defaa"		, output.getNext().getNext().getNext().getNext().getNext().getNext().getElement());
		assertEquals("bcaa"	, output.getNext().getNext().getNext().getNext().getNext().getNext().getNext().getElement());
